...
export default function ChatbotScreen() {
  const { isDarkMode, footData, calculateRiskScore, gaitAnalysis } = useSensor();
...
- Gait pattern: ${gaitAnalysis.gaitPattern}
- Cadence: ${gaitAnalysis.cadenceSpm.toFixed(0)} spm
- High-risk zone: ${gaitAnalysis.highRiskZone}
- IWGDF-style category: ${gaitAnalysis.iwgdfCategory}
