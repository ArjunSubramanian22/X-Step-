...
export default function FootMap({
  ...
  const zones: { zone: FootZone; x: number; y: number; label: string }[] = [
    { zone: 'toes', x: foot === 'left' ? FOOT_WIDTH * 0.35 : FOOT_WIDTH * 0.65, y: FOOT_HEIGHT * 0.32, label: '1st MT' },
    { zone: 'ball', x: foot === 'left' ? FOOT_WIDTH * 0.65 : FOOT_WIDTH * 0.35, y: FOOT_HEIGHT * 0.35, label: '2nd MT' },
    { zone: 'arch', x: foot === 'left' ? FOOT_WIDTH * 0.28 : FOOT_WIDTH * 0.72, y: FOOT_HEIGHT * 0.42, label: '5th MT' },
