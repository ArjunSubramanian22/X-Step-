...
| Subject count | Always 24 virtual; 0 human | Stated in Table II and abstract | `manifest.json`, `data_inventory.json` |
...
| Calibration | MAE as if bench | Labeled simulated_example; `physical_bench_present: false` | `calibration_evaluation.json` |
