...
def main() -> dict:
    ...
    hum = json.loads((RES / "human_optitrack_evaluation.json").read_text()) if (RES / "human_optitrack_evaluation.json").exists() else {}
    ...
    entries = [
        ...
        _entry(
            ...
            extra={"note": "X-Step four-site FSR402 walking remains absent"},
        ),
        _entry(
            key="n_subjects_human_32site",
            metric="n_subjects",
            value=int(hum.get("n_subjects") or 0),
            experiment="human_32site_optitrack_sparse_vs_dense",
            dataset="human_32site_insole_optitrack",
            split="n/a",
            n_subjects=int(hum.get("n_subjects") or 0),
            n_sessions=int(hum.get("n_takes_analyzed") or 0),
            synthetic_or_real="real",
            result_file="research/results/human_optitrack_evaluation.json",
            extra={"note": "32-cell insole + OptiTrack; not X-Step 4-FSR402"},
        ),
        _entry(
            key="n_takes_human_32site",
            metric="n_sessions",
            value=int(hum.get("n_takes_analyzed") or 0),
            experiment="human_32site_optitrack_sparse_vs_dense",
            dataset="human_32site_insole_optitrack",
            split="n/a",
            n_subjects=int(hum.get("n_subjects") or 0),
        ...
        _entry(
            ...
            experiment="calibration_four_site_fsr_bench",
            dataset="four_site_fsr_bench",
            split="n/a",
            n_subjects=0,
            n_sessions=0,
            synthetic_or_real="bench",
            result_file="research/results/calibration_evaluation.json",
            extra={"display": f"{float(cal['mae_n']):.2f} N" if cal.get("mae_n") is not None else "n/a", "physical_bench": bool(cal.get("physical_bench_present"))},
        ),
        _entry(
        ...
        _entry(
            key="human_32site_copy_r",
            metric="pearson_r",
            value=_f(hum.get("median_copy_r")),
            experiment="human_32site_optitrack_sparse_vs_dense",
            dataset="human_32site_insole_optitrack",
            split="n/a",
            n_subjects=int(hum.get("n_subjects") or 0),
        ...
        _entry(
            key="human_32site_copx_r",
            metric="pearson_r",
            value=_f(hum.get("median_copx_r")),
            experiment="human_32site_optitrack_sparse_vs_dense",
            dataset="human_32site_insole_optitrack",
            split="n/a",
            n_subjects=int(hum.get("n_subjects") or 0),
        ...
        _entry(
            key="human_32site_speed_m_s",
            metric="speed_m_s",
            value=_f(hum.get("median_speed_m_s_assumed_64hz")),
            experiment="human_32site_optitrack_sparse_vs_dense",
            dataset="human_32site_insole_optitrack",
            split="n/a",
            n_subjects=int(hum.get("n_subjects") or 0),
        ...
        _entry(
            key="human_32site_met1_timeseries_r",
            metric="pearson_r",
            value=_f(next((r.get("median_timeseries_r") for r in (hum.get("per_region") or []) if r.get("site") == "met1"), None)),
            experiment="human_32site_optitrack_sparse_vs_dense",
            dataset="human_32site_insole_optitrack",
            split="n/a",
            n_subjects=int(hum.get("n_subjects") or 0),
        ...
        _entry(
            key="human_32site_met2_timeseries_r",
            metric="pearson_r",
            value=_f(next((r.get("median_timeseries_r") for r in (hum.get("per_region") or []) if r.get("site") == "met2"), None)),
            experiment="human_32site_optitrack_sparse_vs_dense",
            dataset="human_32site_insole_optitrack",
            split="n/a",
            n_subjects=int(hum.get("n_subjects") or 0),
        ...
        _entry(
            key="human_32site_met5_timeseries_r",
            metric="pearson_r",
            value=_f(next((r.get("median_timeseries_r") for r in (hum.get("per_region") or []) if r.get("site") == "met5"), None)),
            experiment="human_32site_optitrack_sparse_vs_dense",
            dataset="human_32site_insole_optitrack",
            split="n/a",
            n_subjects=int(hum.get("n_subjects") or 0),
        ...
        _entry(
            key="human_32site_heel_timeseries_r",
            metric="pearson_r",
            value=_f(next((r.get("median_timeseries_r") for r in (hum.get("per_region") or []) if r.get("site") == "heel"), None)),
            experiment="human_32site_optitrack_sparse_vs_dense",
            dataset="human_32site_insole_optitrack",
            split="n/a",
            n_subjects=int(hum.get("n_subjects") or 0),
    ...
    for e in entries:
        if e["key"] == "logreg_grouped_macro_f1" and e.get("value") is not None and e.get("confidence_interval"):
            ...
            e["display"] = f"{e['value']:.2f} N"
        elif e["metric"] == "pearson_r" and isinstance(e.get("value"), float):
            e["display"] = f"{e['value']:.3f}"
        elif e["key"] == "human_32site_speed_m_s" and isinstance(e.get("value"), float):
            e["display"] = f"{e['value']:.2f} m/s"
